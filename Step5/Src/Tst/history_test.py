import random
from Src.Models.nomenclature_history import nomenclature_hostory
import unittest
import uuid
...
class history_test(unittest.TestCase):
    ...
    def get_nomenclature_hostory():
        ...
        for nomenclature_code in keys:
            ...
            item.turn = random.uniform(-10, 10)
            items.append(item)
    ...
    #        
    def test_get_nomenclature_hostory(self):
        # Подготовка
        
        # Действия
        items =  history_test.get_nomenclature_hostory()
